        ...
        <div className='auth-page'>
            ...
            <div className='auth-left'>
                <div className='auth-left__brand'>
                    ...
                    <span className='auth-left__brand-name'>InterviewAI</span>
                </div>
            ...
            <div className='auth-right'>
                ...
                <div className='auth-card'>
                    ...
                    <p className='auth-card__subtitle'>Access your training dashboard and continue your journey.</p>
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className='auth-field'>
                            <div className='auth-field__label-row'>
                                ...
                                <a href='#' className='auth-field__forgot'>Forgot?</a>
                            </div>
                            <div className='auth-field__input-wrap'>
                                <span className='auth-field__icon'>
